        ...
        <section className="grid gap-4 lg:grid-cols-3">
          ...
          <div className="bg-card border border-border rounded-2xl p-5">
            ...
            <div className="mt-4 space-y-3">
              {stuckIdeas.length === 0 && (
                <p className="text-sm text-muted-foreground">
                  Everything has been touched in the last week. Keep the cadence and capture wins.
                </p>
              )}
            ...
            {stuckIdeas.length > 3 && (
              <p className="text-xs text-muted-foreground mt-2">+{stuckIdeas.length - 3} more waiting for a nudge.</p>
            )}
            <div className="mt-4">
